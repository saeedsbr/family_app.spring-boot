...
public class EmailService {
    ...
    public void sendResetPasswordEmail(String to, String resetLink) {
        try {
            ...
            helper.setTo(to);
            helper.setSubject("Reset Your Password - Life Pulse");
            ...
            String htmlContent = String.format(
                ...
                "<h1 style='color: white; margin: 0; font-size: 24px;'>Life Pulse</h1>" +
                "</div>" +
                ...
                "<p style='color: #94a3b8; font-size: 12px;'>© 2026 Life Pulse. All rights reserved.</p>" +
                "</div>" +
                "</div>",
                resetLink, resetLink);
